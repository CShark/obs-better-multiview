...
namespace OBSWebsocketDotNet {
    ...
    public partial class OBSWebsocket {
        ...
        public SourceScreenshotResponse TakeSourceScreenshot(string sourceName, string embedPictureFormat = null,
            string saveToFilePath = null, int width = -1, int height = -1) {
        ...
        public SceneItemProperties GetSceneItemProperties(string itemName, string sceneName = null) {
            return JsonConvert.DeserializeObject<SceneItemProperties>(GetSceneItemPropertiesJson(itemName, sceneName)
                .ToString());
        }
        ...
        /// <param name="sceneName">(optional) name of the scene the item belongs to</param>
        [Obsolete("Deprecated! Please use SetSceneItemProperties(). Will be removed in a future update")]
        public void SetSceneItemTransform(string itemName, float rotation = 0, float xScale = 1, float yScale = 1,
        ...
        public BrowserSourceProperties GetBrowserSourceProperties(string sourceName, string sceneName = null) {
            ...
            if (response[SOURCE_TYPE_JSON_FIELD].ToString() != SOURCE_TYPE_BROWSER_SOURCE) {
                throw new Exception(
                    $"Invalid source_type. Expected: {SOURCE_TYPE_BROWSER_SOURCE} Received: {response[SOURCE_TYPE_JSON_FIELD]}");
            }
        ...
        public void SetBrowserSourceProperties(string sourceName, BrowserSourceProperties props,
            string sceneName = null) {
        ...
        public void OpenProjector(string projectorType = "preview", int monitor = -1, string geometry = null,
            string name = null) {
            var request = new JObject {
                {"type", projectorType},
                {"monitor", monitor}
        ...
        public int CreateSource(string sourceName, string sourceKind, string sceneName, JObject sourceSettings,
            bool? setVisible) {
            var request = new JObject {
                {"sourceName", sourceName},
